...
import { AlertInfo } from "@/app/Components/AdminAlertModel/AlertInfo";
import { AlertIndicator } from "@/app/Components/AdminAlertModel/AlertIndicator";
import { AlertStatusUpdation } from "@/app/Components/AdminAlertModel/AlertStatusUpdation";
import { AlertReportButton } from "@/app/Components/AdminAlertModel/AlertReportButton";
        ...
        <div className="absolute top-[100px] left-5 w-[400px] bg-white/95 backdrop-blur-sm text-zinc-900 shadow-xl rounded-lg border border-gray-200 overflow-y-auto max-h-[calc(100vh-120px)] z-40">
          {showAlertModel && (
            <div className="p-3 space-y-3 font-martianmono">
              ...
              <AlertInfo/>
              <AlertStatusUpdation/>
              <AlertReportButton onConfirm={handleConfirm}/>
            </div>          
          )}
        </div>
