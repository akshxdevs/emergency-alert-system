export const ServiceListCard = () => {
    return <div className="font-gilroyLight absolute top-[480px] left-1/2 transform -translate-x-1/2 w-full max-w-full">
            ...
            <div className="flex justify-between gap-10 pb-10">
                <div className="flex flex-col gap-10 py-5">
                    <div className="flex justify-center items-center gap-2 border border-red-500 rounded-lg p-3">
                        ...
                        <h1>Receive alerts about accidents, injuries, and health-related crises in your</h1>
                    </div>
                    <div className="flex justify-center items-center gap-2 border border-red-500 rounded-lg p-3">
                        <img width="30" height="30" src="https://img.icons8.com/ios/50/policeman-male.png" alt="policeman-male"/>                       
                        <h1>Stay informed about law enforcement activity and public safety concerns.</h1>
                    </div>
                    <div className="flex items-center gap-2 border border-red-500 rounded-lg p-3">
                        ...
                        <h1>Get instant notifications about nearby fire hazards and outbreaks.</h1>
                    </div>
                </div>
                <div>
