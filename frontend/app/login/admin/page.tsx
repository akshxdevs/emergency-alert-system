...
export default function AdminLoginPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    // Validate admin role
    if (!["POLICE", "FIRE", "MEDICAL"].includes(selectedRole)) {
      ...
      if (result?.ok) {
        setTimeout(async () => {
          ...
          if (userId) {
            ...
            if (userRole === "POLICE" || userRole === "FIRE" || userRole === "MEDICAL") {
      ...
      <motion.div
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-400 text-sm">
            {isSignup ? "Sign up for emergency response access" : "Access emergency response dashboard"}
          </p>
        </div>
        ...
        <form onSubmit={isSignup ? handleSignup : handleSubmit} className="space-y-4">
          ...
          >
            {isLoading 
              ...
              : (isSignup ? "Create Admin Account" : "Sign in with Credentials")
            }
          </motion.button>
        </form>
        ...
        <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
          <h3 className="text-blue-400 font-semibold mb-2">Admin Access</h3>
          <p className="text-gray-400 text-sm">
            This login is restricted to emergency response personnel:
          </p>
